...
from scripts.config import (
    ...
    TIKTOK_COMMENT_TASKS_FINISHED_TOPIC
)
           ...
           # if task is finished send to finished Topic
            ...
            producer.produce(
                ...
                value=task_serializer(
                    task_data,
                    SerializationContext(TIKTOK_COMMENT_TASKS_FINISHED_TOPIC, MessageField.VALUE)),
...
def main():
    consumer_conf['group.id'] = 'tiktok_check_comment_tasks'
    consumer = Consumer(consumer_conf)
    consumer.subscribe([TIKTOK_COMMENT_TASKS_TOPIC])
    WAIT_COUNT = 0
