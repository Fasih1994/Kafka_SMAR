...
def update_post_task(msg=None, term_data: dict=None):
    update_url = "https://api.data365.co/v1.1/tiktok/search/post/update"
    params = {
    ...
    if r.status_code == 202:
        ...
        producer.produce(
            TIKTOK_POST_TASKS_TOPIC,
            key=msg.key(),
            value=task_serializer(data, SerializationContext(TIKTOK_POST_TASKS_TOPIC, MessageField.VALUE)),
...
def main():
    consumer_conf['group.id'] = 'tiktok_update_post_tasks'
