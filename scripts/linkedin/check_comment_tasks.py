           ...
           # if task is finished send to finished Topic
            ...
            producer.produce(
                ...
                value=task_serializer(
                    task_data,
                    SerializationContext(LINKEDIN_COMMENT_TASKS_FINISHED_TOPIC, MessageField.VALUE)),
...
def main():
    consumer_conf['group.id'] = 'linkedin_check_comment_tasks'
    consumer = Consumer(consumer_conf)
    consumer.subscribe([LINKEDIN_COMMENT_TASKS_TOPIC])
    WAIT_COUNT = 0
